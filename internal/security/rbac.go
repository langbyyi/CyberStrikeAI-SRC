...
var PermissionCatalog = map[string]string{
	...
	"approval:read":         "View unified approval queues and decisions",
	"approval:decide":       "Approve or reject pending unified approvals",
	"approval:policy:write": "Manage approval policies and danger rules",
