...
func TestHITLBuiltInWhitelistExemptsMetaTools(t *testing.T) {
	h := &AgentHandler{}
	...
	if manager.NeedsToolApproval("conversation-1", "exit") {
		t.Fatal("exit should use the built-in HITL exemption")
	}
